...
export const CustomerKpis = () => {
  ...
  //
  return (
    <section className="flex-cc min-h-[800px] bg-[url('/images/cover-white-crosses.png')] bg-contain bg-no-repeat">
      <div className="container-md text-center">
      <div className="min-h-[550px]"></div>
        ...
        <div className="flex-cs mt-10 h-[320px] bg-[url('/images/cover-worldwide.png')] bg-contain bg-no-repeat">
          <div className="flex-cs w-[1080px]">
            {renderKpi(tuple[0])}
            {renderKpi(tuple[1])}
          </div>
        </div>
